...
from OXscrapy.items import OxscrapyItem
from urllib import parse
import re
import copy

class OxadmissionscrapySpider(scrapy.Spider):
    name = 'OXadmissionscrapy'
    # allowed_domains = ['https://www.admissionreport.com/university-college-london/all']
    start_urls = ['https://www.admissionreport.com/university-of-oxford/all']
