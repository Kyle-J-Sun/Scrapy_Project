...
from ICscrapy.items import IcscrapyItem
from urllib import parse
import re
import copy

class IcadmissionscrapySpider(scrapy.Spider):
    name = 'ICadmissionscrapy'
    # allowed_domains = ['https://www.admissionreport.com/university-college-london/all']
    start_urls = ['https://www.admissionreport.com/imperial-college-london/all']
