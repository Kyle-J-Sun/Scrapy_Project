...
from CAMscrapy.items import CamscrapyItem
from urllib import parse
import re
import copy

class CamadmissionscrapySpider(scrapy.Spider):
    name = 'CAMadmissionscrapy'
    # allowed_domains = ['https://www.admissionreport.com/university-college-london/all']
    start_urls = ['https://www.admissionreport.com/university-of-cambridge/all']
