...
from UCLscrapy.items import UclscrapyItem
from urllib import parse
import re
import copy

class UcladmissionscrapySpider(scrapy.Spider):
    name = 'UCLadmissionscrapy'
    # allowed_domains = ['https://www.admissionreport.com/university-college-london/all']
    start_urls = ['https://www.admissionreport.com/university-college-london/all']
