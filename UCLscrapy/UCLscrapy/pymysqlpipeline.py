...
class MySQLUCLPipline(object):
    ...
    def process_item(self, item, spider):
        sql = 'insert into UCL_adm_report (Coursename, Acc_Rate, Adm_Rate, En_Year, Apply_Num, Offer_Num, Adm_Num, href) values (%s, %s, %s, %s, %s, %s, %s, %s);'
